...
export class Mat {
  ...
  setAt(value: number, mask?: Mat): Mat;
  setAt(value: number[], mask?: Mat): Mat;
  setAt(value: Vec2, mask?: Mat): Mat;
  setAt(value: Vec3, mask?: Mat): Mat;
  setAt(value: Vec4, mask?: Mat): Mat;
  setAtAsync(value: number, mask?: Mat): Promise<Mat>;
  setAtAsync(value: number[], mask?: Mat): Promise<Mat>;
  setAtAsync(value: Vec2, mask?: Mat): Promise<Mat>;
  setAtAsync(value: Vec3, mask?: Mat): Promise<Mat>;
  setAtAsync(value: Vec4, mask?: Mat): Promise<Mat>;
