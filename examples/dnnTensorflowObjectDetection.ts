...
async function main() {
  ...
  const pbFile = path.resolve(__dirname, detectionModelPath, "frozen_inference_graph.pb");
  // const pbtxtFile = path.resolve(
  //   detectionModelPath,
  //   "ssd_mobilenet_v2_coco_2018_03_29.pbtxt"
  // );

  const pbtxtFile = await getCachedFile("../data/dnn/tf-detection/ssd_mobilenet_v2_coco_2018_03_29.pbtxt", 'https://raw.githubusercontent.com/opencv/opencv_extra/master/testdata/dnn/ssd_mobilenet_v2_coco_2018_03_29.pbtxt')
