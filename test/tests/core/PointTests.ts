...
export default function (args: TestContext) {
  ...
  describe('constructor', () => {
    ...
    describe('Point2', () => {
      ...
      describe('operators', () => {
        const pt0 = new cv.Point2(1, 1);
        const pt1 = new cv.Point2(2, 3);
        ...
        describe('norm', () => {
          it('should return magnitude', () => {
            expect(new cv.Point2(Math.sqrt(8), Math.sqrt(8)).norm()).to.equal(4);
          });
        });
      });
    });
    ...
    describe('Point3', () => {
      ...
      describe('at', () => {
        const pt3 = new cv.Point3(10, 20, 30);
        it('should throw index out of bounds', () => {
      ...
      describe('operators', () => {
        const pt0 = new cv.Point3(1, 1, 1);
        const pt1 = new cv.Point3(2, 3, 4);
        const operatorRequiresArg = OperatorRequiresArg(pt0);
        describe('add', () => {
          operatorRequiresArg('add');
        ...
        describe('norm', () => {
          it('should return magnitude', () => {
            expect(new cv.Point3(Math.sqrt(4), Math.sqrt(4), Math.sqrt(8)).norm()).to.equal(4);
          });
        });
      });
    });
